...
game1 = Game.create!(title: "Alerte à Lille ! ", synopsis: "Au cœur de Lille, un danger sans précédent se profile, émanant d'un criminel connu sous le nom du <strong>Pélican</strong>.
  Ce fou dangereux à pour projet de semer le chaos dans le centre ville de Lille et menance de faire sauter une bombe fabriquée à base d'Orge et de Malt . Vous avez <strong>60 minutes</strong> pour l'arreter.
...
enigma4 = Enigma.create!(enigma_type: "minigame", title: "l'huitrière", description: "Sur la mosaique, tes yeux sont rivés, Le homard en 8 morceaux est divisé </br> Tel un puzzle, les fragments sont eparpillés </br> ton défi est de le reconstituer.", game_id: game1.id, point_of_interest_id: poi3.id, order_in_the_game: 4)
#RECONSTITUER LA PHOTO


#ETAPE 4 : HOSPICE COMTESSE
poi4 = PointOfInterest.create!(titre: "Le lion des Flandres", anecdote: "le Lion des Flandres est toujours largement utilisé comme symbole culturel et identitaire dans la région. </br> Son origine remonte au Moyen Âge, où il est apparu dans les armes des comtes de Flandre.", indication_next_step: "Depuis l'îlot, rebrousse ton chemin jusqu’à l’ancien moulin; La rue de la Monnaie tu descends, puis une perpendiculaire tu prends. Aux vieux murs tu parviens, là où <strong>“le Vieux de la Vieille”</strong> en sentinelle se tient.", poster_url: "https://imagizer.imageshack.com/img922/6328/0qdPK9.png")
