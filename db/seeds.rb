...
game1 = Game.create(title: "Alerte à Lille", synopsis:"Au cœur de Lille, un danger sans précédent se profile, émanant d'un criminel connu sous le nom du Pélican .
    ...
    poster_url: "https://i.ytimg.com/vi/yJcc-IVJe30/maxresdefault.jpg", sub_score: 0, timer: "0", winner_code: "0")





enigma1 = Enigma.create(title: "Un volatile vous surveille....Retrouvez-le", description: " GARE LILLE FLANDRES. Du fer part le voyage, où Flandres te reçoit, Cherche sur les façades, l'oiseau qu'on ne voit.
  Sa présence révèle le début de l'histoire.", order: "1")
