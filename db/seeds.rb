...
game1 = Game.create!(title: "Alerte à Lille ! ", synopsis: "Au cœur de Lille, un danger sans précédent se profile, émanant d'un criminel connu sous le nom du <strong>Pélican</strong>. </br>
  Ce fou dangereux à pour projet de semer le chaos dans le centre ville de Lille et menace de faire sauter une bombe fabriquée à base d'Orge et de Malt. Vous avez <strong>60 minutes</strong> pour l'arreter. </br>
  Si sûr de sa victoire, il a parsemé la ville de mystérieux indices et vous met au défi : saurez-vous déchiffrer ses énigmes et l'arrêter avant que la ville ne sombre dans l'abîme ? </br>
  Plongez dans une aventure palpitante au cœur de Lille, où chaque monument peut receler un indice crucial. </br> L'heure tourne, chaque seconde compte. Mettez votre sens de l'observation et votre esprit de déduction à l'épreuve pour déjouer le plan machiavélique du Pélican.", sub_score: 0, poster_url: "URL de l'affiche du jeu 1", max_duration_in_sec: 3600, winner_code: "à determiner")
...
poi1 = PointOfInterest.create!(titre: "Le Pélican", anecdote: "Fondée en 1921, la brasserie régionale <strong>Pélican</strong> est plus connue aujourd’hui sous le nom de <strong>Pelforth</strong>.", poster_url: "https://imagizer.imageshack.com/img922/6522/0e8DMj.jpg", indication_next_step: "Le Pélican d'or éclaire ta route, suit sa trace au cœur de la déroute.</br> Là où l'or s'échange en rires et en mots, vers la <strong>vieille Bourse</strong>, tu trouveras ton lot." )
...
poi2 = PointOfInterest.create!(titre: "Le passé textile", anecdote: "Le textile a joué un rôle essentiel dans l'essor de la ville de Lille et de sa région. </br> Au XIXe siècle, la région du Nord de la France est devenue un centre majeur de production textile, ayant Roubaix comme épicentre.", poster_url: "https://imagizer.imageshack.com/img924/3034/b4jSAI.jpg", indication_next_step: "Entre ces 2 géants, un bras d’or s’étire, vers <strong>la grande chaussée</strong>, il te fait partir. </br> Cette route t’indique l’ancien hospice, mais avant, un détour par la mer est propice. </br> </br> <strong>Au numéro 3 des chats bossus</strong>, les créatures te guettent, </br> devant la mer de mosaique, tu t’arrêtes.")
enigma2 = Enigma.create!(enigma_type: "figuresenigma", title: "Vieille bourse de Lille", description: "Sous le Campanile, la plaque de Jacquard luit. </br> Les <strong>2 derniers chiffres</strong> de l'année de sa fin, a la ville, peuvent offrir la vie. </br> Vise désormais le rang de Beauregard, là ou la choche d’or retentit, </br> la brasserie Morel, heritière de la bonneterie, juste à sa droite, te conduit vers l’inédit", game_id: game1.id, order_in_the_game: 2)
enigma3 = Enigma.create!(enigma_type: "figuresenigma", title: "Morel & Fils", description: "Le sein Rose de Morel, sur un boulet dessiné, </br> rappelle le siège de Lille, dans l’histoire enraciné. </br> Les <strong>2 derniers chiffres</strong> de l'année de cette bataille, tu garderas en mémoire, </br> c’est la clé du salut dans cette noire histoire. </br> </br> D’ici, regarde en face, le beffroi se dresse fier. </br> De Beethoven, l’hymne à la joie nous parvient chaque heure. </br> Garde précieusement les <strong>2 premiers chiffres</strong> de son année de naissance en tête. </br> </br> Le temps presse, le pélican guette.</br> </br>", game_id: game1.id, point_of_interest_id: poi2.id, order_in_the_game: 3)


#ETAPE 3 : L'HUITRIERE
poi3 = PointOfInterest.create!(titre: "L'Huitrière", anecdote: "Veritable institution Lilloise, l’Huitrière fut un restaurant étoilé de 1932 à sa fermeture en 2016. </br> Sa facade art-déco en mosaique fut réalisée par la renommée maison Gentil & Bourdet.", indication_next_step: "Vers l'<strong>Hospice Comtesse</strong> prends la route. </br> Sur sa facade Est, le mur d'un ancien moulin déroute. </br> Face à lui, , l'<strong>Îlot Comtesse</strong> t'ouvre son verger. </br> A l’ombre du <strong>chevet</strong> de sa chapelle , un nouvel indice l’on peut trouver.", poster_url: "https://imagizer.imageshack.com/img923/963/9Wk6dt.jpg")
enigma4 = Enigma.create!(enigma_type: "minigame", title: "l'huitrière", description: "Sur la mosaique, tes yeux sont rivés. </br> Le homard en 8 morceaux est divisé. </br> Tel un puzzle, les fragments sont eparpillés. </br> Ton défi est de le reconstituer.", game_id: game1.id, point_of_interest_id: poi3.id, order_in_the_game: 4)
#RECONSTITUER LA PHOTO


#ETAPE 4 : HOSPICE COMTESSE
poi4 = PointOfInterest.create!(titre: "Le lion des Flandres", anecdote: "le Lion des Flandres est toujours largement utilisé comme symbole culturel et identitaire dans la région. </br> Son origine remonte au Moyen Âge, où il est apparu dans les armes des comtes de Flandre.", indication_next_step: "Depuis l'îlot, rebrousse ton chemin jusqu’à l’ancien moulin, La rue de la Monnaie tu descends, puis une perpendiculaire tu prends. </br> Aux vieux murs tu parviens, là où <strong>“le Vieux de la Vieille”</strong> en sentinelle se tient.", poster_url: "https://imagizer.imageshack.com/img922/6328/0qdPK9.png")
enigma5 = Enigma.create!(enigma_type: "photos_QCM", title: "Hospice comtesse", description: "Au pied du chevet de la chapelle, 3 blasons s'offrent en querelle. </br> Entre le lion et les drapeaux, ton cœur est en étau. </br> Mais n'oublie pas où tu te tiens, décide et trouve le lien.", game_id: game1.id, point_of_interest_id: poi4.id, order_in_the_game: 5)
...
enigma8 = Enigma.create!(enigma_type: "resolution_game", title: "Grand Place de Lille", description: "La bombe est cachée sous la fontaine, Pour la désamorcer, <strong>regroupe l’ensemble des chiffres que tu as conservé</strong> et réponds à cette énigme finale : </br> La fontaine de la déesse est ton dernier arrêt Rappelle-toi du <strong>jour de juin</strong> où l’appel d’un grand homme a changé notre destinée </br> </br> ajoutes le à ta liste et libère Lille du péché.", game_id: game1.id, point_of_interest_id: poi7.id, order_in_the_game: 8)
