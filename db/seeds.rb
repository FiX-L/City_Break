...
p "CREATING USERS"
user1 = User.create!(email: "foucauld@gmail.com",password: "123456")
...
enigma4 = Enigma.create!(title: "l'huitrière", description: "Sur la mosaique, tes yeux sont rivés Le homard en 8 morceaux est divisé Comme un puzzle, les fragments sont eparpillés, ton défi est de le reconstituer.", game_id: game1.id, point_of_interest_id: poi3.id, order_in_the_game: 4)
...
enigma5 = Enigma.create!(title: "Hospice comtesse", description: "Face au chevet de la chapelle, 3 images s'offrent en querelle. Entre le lion et les drapeaux, ton cœur est en étau. Mais souviens-toi, en Flandres tu te trouves, alors choisis et trouve.", game_id: game1.id, point_of_interest_id: poi4.id, order_in_the_game: 5)
...
enigma7 = Enigma.create!(title: "Cathedrale de la Treille", description: "Ladislas Kijno est son nom, d'une gigantesque rosace, il nous a fait don.Les 2 derniers chiffres de son année d’installation, sauver la ville te permettront.", game_id: game1.id, point_of_interest_id: poi6.id, order_in_the_game: 7)
