...
poi2 = PointOfInterest.create!(titre: "Le passé textile", anecdote: "Le textile a joué un rôle essentiel dans l'essor de la ville de Lille et de sa région.  Au XIXe siècle, la région du Nord de la France est devenue un centre majeur de production textile, avec Lille & Roubaix comme épicentre.", poster_url: "https://imagizer.imageshack.com/img924/3034/b4jSAI.jpg", indication_next_step: "Entre ces 2 géants, un bras d’or s’étire, vers la grande chaussée, il te fait partir.Cette route t’indique l’ancien hospice, mais avant un détour par la mer est propice.Au numéro 3 des chats bossus, les créatures te guettent, devant la mer de mosaique, tu t’arretes.")
...
answer1 = Answer.create(enigma_id: enigma5.id, is_good_answer: true, content: "goodanswer", poster_url: "https://imagizer.imageshack.com/img923/3847/Yk6KMc.jpg")
answer2 = Answer.create(enigma_id: enigma5.id, is_good_answer: false, content: "falseanswer", poster_url: "https://imagizer.imageshack.com/img924/8820/vt64RW.jpg")
answer3 = Answer.create(enigma_id: enigma5.id, is_good_answer: false, content: "falseanswer", poster_url: "https://imagizer.imageshack.com/img922/2177/eGLcSw.jpg")
...
answer1 = Answer.create(enigma_id: enigma6.id, is_good_answer: true, content: "goodanswer", poster_url: "https://imagizer.imageshack.com/img923/6126/9rCgG9.jpg")
answer2 = Answer.create(enigma_id: enigma6.id, is_good_answer: false, content: "falseanswer", poster_url: "https://imagizer.imageshack.com/img924/6107/5TGvHL.jpg")
answer3 = Answer.create(enigma_id: enigma6.id, is_good_answer: false, content: "falseanswer", poster_url: "https://imagizer.imageshack.com/img924/3174/xxrLiC.jpg")
answer4 = Answer.create(enigma_id: enigma6.id, is_good_answer: false, content: "falseanswer", poster_url: "https://imagizer.imageshack.com/img923/6717/dlwJWQ.jpg")
